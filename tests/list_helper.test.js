...
const listWithOneBlogMissingLikes = [
      {
        _id: '5a422aa71b54a676234d17f8',
        title: 'Go To Statement Considered Harmful',
        author: 'Edsger W. Dijkstra',
...
describe('total likes', () => {
    ...
    test('of a list with one blog missing likes is calculated right', () => {
        expect(listHelper.totalLikes(listWithOneBlogMissingLikes)).toBe(5)
    })
})
...
describe('favorite blog', () => {
    ...
    test('of empty list is NaN', () => {
        expect(listHelper.favoriteBlog([])).toBe(NaN)
    })
